...
class GitHubPluginRESTClient {

    private static String BEARER_PREFIX = 'Bearer'
    private static String USER_AGENT = 'GitHubPluginRESTClient REST Client'
    ...
    GitHubPluginRESTClient(String endpoint, RESTConfig restConfig, FlowPlugin plugin) {
    ...
    /**
     * Will create a GitHubPluginRESTClient object from the plugin Config object.
     * Convenient as it can use pre-defined configuration fields.
     */
    static GitHubPluginRESTClient fromConfig(Config config, FlowPlugin plugin) {
        Map params = [:]
        ...
        return new GitHubPluginRESTClient(endpoint, restConfig, plugin)
    }
    ...
    /** Generated code for the endpoint /user
    * Do not change this code
    * username: in path
    */
    def getUser(Map<String, Object> params) {
        this.method = 'getUser'
...
// DO NOT EDIT THIS BLOCK ABOVE ^^^=== rest client ends, checksum: 3622475e5b8ebdb8151d2e4072311363 ===
    /**
